...
Magic Romak is a 24-key layout for English and Brazilian Portuguese. Two alpha
layers, a sticky second layer for the rarer letters and the accents, and a magic
key that types `v` after a vowel and `h` after a consonant.
