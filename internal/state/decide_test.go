...
func TestDecide(t *testing.T) {
	...
	cases := []struct {
		...
		{"obsidian under its Wayland app_id → legacy without a client",
			Snapshot{Frontmost: app("md.obsidian.Obsidian")}, Legacy, CodeLegacy, 0},
		{"obsidian under its Wayland app_id → its client's mode",
			Snapshot{Frontmost: app("md.obsidian.Obsidian"), Clients: []Client{{ID: 3, Kind: "obsidian", App: "obsidian", Mode: Visual, EventSeq: 1}}}, Visual, CodeVisual, 3},
		...
		{"intellij on macOS (bundle id) → legacy without the plugin",
			Snapshot{Frontmost: app("com.jetbrains.intellij")}, Legacy, CodeLegacy, 0},
		{"intellij with its plugin reporting → that mode",
			Snapshot{Frontmost: app("com.jetbrains.intellij"), Clients: []Client{{ID: 4, Kind: "intellij", App: "intellij", Mode: Insert, EventSeq: 1}}}, Insert, CodeInsert, 4},
		{"intellij plugin says raw (focus left the editor)",
			Snapshot{Frontmost: app("jetbrains-idea"), Clients: []Client{{ID: 4, Kind: "intellij", App: "intellij", Mode: Raw, EventSeq: 1}}}, Raw, CodeRaw, 4},
		{"intellij plugin with no opinion (operator pending) → legacy",
			Snapshot{Frontmost: app("jetbrains-idea"), Clients: []Client{{ID: 4, Kind: "intellij", App: "intellij", Mode: None, EventSeq: 1}}}, Legacy, CodeLegacy, 0},
